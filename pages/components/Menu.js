    ...
    <div>
      <div className="w-full h-screen">
        <section
          ...
          className="block fixed inset-x-0 bottom-0 z-10 backdrop-filter backdrop-blur bg-opacity-75 bg-white shadow"
        >
          <div id="tabs" className="flex justify-between">
            <Link href="/">
              <a className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
                ...
                <span className="tab tab-home block text-xs">Start</span>
              </a>
            </Link>
